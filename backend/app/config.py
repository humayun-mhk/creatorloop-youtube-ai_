...
class Settings(BaseSettings):
    ...
    creator_reply_style: str = "Friendly, concise, helpful, and conversational"
    comment_reply_policy: str = (
        "Reply when the viewer asks a useful question, requests content, reports a meaningful problem, "
        "or gives feedback that benefits from a response. Do not reply to spam, promotion, abusive noise, "
